...
# Result
Analysis and visualization of data can be seen in [titanic.ipynb](https://github.com/delat22/Titanic-project/blob/master/titanic.ipynb) file attached to the link of this file.
